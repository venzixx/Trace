...
class AttackSimulator:
    ...
    def generate_clean_transaction() -> TransactionPayload:
        ...
        telemetry = WireTelemetry(
            ...
            server_ip="52.66.191.144", # Razorpay Mumbai AWS Ingress
            tcp_rtt_ms=rtt,
            ...
            cisco_splt_entropy=round(random.uniform(2.8, 3.6), 2),
    ...
    def generate_cloaked_casino_transaction() -> TransactionPayload:
        ...
        telemetry = WireTelemetry(
            ...
            asn_type="Datacenter",
            cisco_splt_entropy=round(random.uniform(0.3, 0.8), 2),
    ...
    def generate_bot_swarm_transaction() -> TransactionPayload:
        ...
        telemetry = WireTelemetry(
            ...
            asn_type="Datacenter",
            cisco_splt_entropy=0.18, # Zero variance
